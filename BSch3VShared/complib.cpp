            ...
            if(0 < n && n < l) {    // : で分けられたレコードである
                ...
                if(var == "N") {
                    ...
                    for(i = 0; i < len; i++) {
                        ...
                        case 'Z':
                            nType |= PIN_TYPE_ZLENG;
                            break;
                        case 'S':
                            nType |= PIN_TYPE_SMALL;
                            break;
                        case 'N':
                            nType |= PIN_TYPE_NEGATIVE;
                            break;
                        case 'C':
                            nType |= PIN_TYPE_CLOCK;
                            break;
                        case 'm':
                            nType |= PIN_TYPE_NUMHIDE;
                            break;
                        }
                    }
                    m_nType = nType;
